...
export default function SiteMenuOverlay({
	...
	const interactiveRowClassName =
		"grid w-full cursor-pointer grid-cols-[auto_1fr_auto] items-end gap-3 border-b border-[#291F1E] py-5 text-left no-underline transition last:border-b-0 hover:opacity-90";
